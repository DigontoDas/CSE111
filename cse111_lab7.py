...
Original file is located at
    https://colab.research.google.com/drive/1IqOqcNSmmuGo7QwSRnWcO93yY5D5xKUa
...
class Player(SportsPerson):
  ...
  def calculate_ratio(self):
    ...
    self.earn = (self.goal* 1000) +(self.total*10)
